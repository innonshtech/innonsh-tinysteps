      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Schedule and manage examinations</p>
          </div>
          <div className="flex gap-3">
            <button type="button" onClick={() => exportToCSV(exams, "exams.csv")} className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-all">
        ...
        <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 border border-cyan-200 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-cyan-600">{scheduledExams}</p>
            </div>
            <div className="w-10 h-10 bg-white/60 rounded-full flex items-center justify-center backdrop-blur-sm text-cyan-600">
        ...
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 border border-amber-200 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-amber-600">{ongoingExams}</p>
            </div>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button type="button" onClick={handleSaveExam} variant="primary">
